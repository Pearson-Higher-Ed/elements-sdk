...
describe('TextInput', () => {
  ...
  describe('Basic TextInput Test', function() {
    ...
    it('should have aria-describedby match any messages', function(){
      ...
      this.wrapper.instance().componentDidMount();
      expect(this.wrapper.find('input').node.props['aria-describedby']).toEqual('infoMsg-textInputTestId7')
    });
    ...
    it('should have aria-describedby match any errors', function(){
      ...
      this.wrapper.instance().componentDidMount();
      expect(this.wrapper.find('input').node.props['aria-describedby']).toEqual('errMsg-textInputTestId8 ')
    });
