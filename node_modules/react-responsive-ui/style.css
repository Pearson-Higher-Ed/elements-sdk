...
/* https://unpkg.com/react-day-picker@latest/lib/style.css */
/* DayPicker styles */
.DayPicker {
  display: inline-block; }
...
.rrui__date-picker__collapsible {
  padding-top: calc(0.3rem * 6);
  padding-bottom: calc(0.3rem * 6); }
...
.rrui__input-label--required.rrui__text-input__label--placeholder:after {
  margin-left: 0.3em;
  font-size: 0.8em; }
